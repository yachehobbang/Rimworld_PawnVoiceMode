...
public static class CaravanInventoryUtility
{
	...
	{
		return TryGetDrugToSatisfyChemicalNeed_NewTemp(caravan, forPawn, chemical.AddictionHediff, out drug, out owner);
	}

	public static bool TryGetDrugToSatisfyChemicalNeed_NewTemp(Caravan caravan, Pawn forPawn, Hediff hediff, out Thing drug, out Pawn owner)
	{
		if (hediff == null)
		{
			drug = null;
