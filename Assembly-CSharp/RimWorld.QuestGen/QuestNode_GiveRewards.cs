...
public class QuestNode_GiveRewards : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		}, variants.GetValue(QuestGen.slate), addCampLootReward.GetValue(QuestGen.slate), QuestGen.slate.Get<Pawn>("asker"), addShuttleLootReward: false, addPossibleFutureReward: false, null);
	}
