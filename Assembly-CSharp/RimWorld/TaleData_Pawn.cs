...
public class TaleData_Pawn : TaleData
{
	...
	{
		return GrammarUtility.RulesForPawn(prefix, name, title, kind, gender, faction, age, chronologicalAge, relationInfo, everBeenColonistOrTameAnimal, everBeenQuestLodger, isFactionLeader, royalTitles, constants);
	}
	...
	public static TaleData_Pawn GenerateRandom(bool humanLike = false)
	{
		...
		Faction faction = FactionUtility.DefaultFactionFrom(obj.defaultFactionType);
