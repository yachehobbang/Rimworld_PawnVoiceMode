...
public class Page_SelectStartingSite : Page
{
	...
	private void DoCustomBottomButtons()
	{
		...
		{
			if (Widgets.ButtonText(new Rect(num6, num7, Page.BottomButSize.x, Page.BottomButSize.y), "Advanced".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
			{
