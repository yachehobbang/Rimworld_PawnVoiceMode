...
public class Pawn_FilthTracker : IExposable
{
	...
	public void Notify_EnteredNewCell()
	{
		...
		else if (pawn.IsNonMutantAnimal && FilthMaker.TryMakeFilth(pawn.Position, pawn.Map, ThingDefOf.Filth_AnimalFilth, 1, AdditionalFilthSourceFlags | FilthSourceFlags.Pawn))
		{
