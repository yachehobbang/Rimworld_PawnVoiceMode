	...
	public static void MakeColony(params ColonyMakerFlag[] flags)
	{
		...
		if (flags.Contains(ColonyMakerFlag.Fire))
		{
			...
			foreach (IntVec3 item8 in result3)
			{
				...
				{
					GenExplosion.DoExplosion(item8, Find.CurrentMap, 3.9f, DamageDefOf.Flame, null, -1, -1f, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
				}
			}
		}
