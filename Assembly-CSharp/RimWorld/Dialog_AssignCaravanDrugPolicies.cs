...
public class Dialog_AssignCaravanDrugPolicies : Window
{
	...
	public override void DoWindowContents(Rect rect)
	{
		...
		float num = 0f;
		if (Widgets.ButtonText(new Rect(rect.width - 354f - 16f, num, 354f, 32f), "ManageDrugPolicies".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
