...
public class LordJob_MechanoidsDefend : LordJob_MechanoidDefendBase
{
	...
	public override StateGraph CreateGraph()
	{
		...
		LordToil_DefendPoint lordToil_DefendPoint = (LordToil_DefendPoint)(stateGraph.StartingToil = new LordToil_DefendPoint(defSpot, defendRadius, null));
		...
		if (canAssaultColony)
		{
			...
			transition2.AddTrigger(new Trigger_PawnHarmed(0.5f, requireInstigatorWithFaction: true, null, null, null));
