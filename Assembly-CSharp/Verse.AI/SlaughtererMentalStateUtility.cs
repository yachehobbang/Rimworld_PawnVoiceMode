...
public static class SlaughtererMentalStateUtility
{
	...
	public static Pawn FindAnimal(Pawn pawn)
	{
		...
		for (int i = 0; i < allPawnsSpawned.Count; i++)
		{
			...
			if (pawn2.IsNonMutantAnimal && pawn2.Faction == pawn.Faction && pawn2 != pawn && !pawn2.IsBurning() && !pawn2.InAggroMentalState && pawn.CanReserveAndReach(pawn2, PathEndMode.Touch, Danger.Deadly))
			{
