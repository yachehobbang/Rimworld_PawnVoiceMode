...
public class SectionLayer_LightingOverlay : SectionLayer
{
	...
	public override void Regenerate()
	{
		...
		CalculateVertexIndices(sectRect.minX, sectRect.minZ, out var botLeft, out var _, out var topRight, out var botRight, out var center);
		...
		CalculateVertexIndices(sectRect.minX, sectRect.minZ, out var botLeft2, out center, out botRight, out topRight, out var center2);
