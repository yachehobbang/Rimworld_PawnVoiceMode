...
public class Listing_ScenEdit : Listing_Standard
{
	...
	public Rect GetScenPartRect(ScenPart part, float height)
	{
		...
		if (part.def.PlayerAddRemovable && widgetRow.ButtonIcon(TexButton.Delete, null, GenUI.SubtleMouseoverColor, null, null))
		{
			scen.RemovePart(part);
			SoundDefOf.Click.PlayOneShotOnCamera();
		}
		if (scen.CanReorder(part, ReorderDirection.Up) && widgetRow.ButtonIcon(TexButton.ReorderUp, null, null, null, null))
		{
			scen.Reorder(part, ReorderDirection.Up);
			SoundDefOf.Tick_High.PlayOneShotOnCamera();
		}
		if (scen.CanReorder(part, ReorderDirection.Down) && widgetRow.ButtonIcon(TexButton.ReorderDown, null, null, null, null))
		{
